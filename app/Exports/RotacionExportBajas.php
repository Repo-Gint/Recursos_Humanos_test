...
class RotacionExportBajas implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
	use Exportable;
    ...
    public function collection()
    {
        ...
        foreach($this->empleados as $empleado){
            ...
            foreach($empleado->Contrataciones as $contrat){
                if( (($this->fecha_inicio <= $contrat->Low_date) && ($this->fecha_fin >= $contrat->Low_date))) {
                    $cnt++;
