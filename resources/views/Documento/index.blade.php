        ...
        <div class="box">
            <div class="box-header">
                ...
                <a href="{{ route('Documento.create') }}">
                    <button class="btn btn-success" style="float: right; margin-right: 10px;"><i class="fa fa-plus"></i> Añadir Documento
                    </button>
                </a>
                @endcan
            </div>
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-sm" id="tb_documento" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Documento</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    @can('Documento.edit')
                                    <a href="{{ route('Documento.edit', $documento->Slug) }}">
