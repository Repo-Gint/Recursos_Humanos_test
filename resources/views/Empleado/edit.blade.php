...
@php
    ...
    $tipo_empleado = $empleado->Tipo_empleado->last();
            ...
            <div class="box-body">
                ...
                <div class="form-group row">
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        ...
                        {!!  Form::select('Company_id', $empresas, $empleado->Company_id, ['class' => 'form-control', 'placeholder' => 'Selecciona un pais']) !!}
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        {!!  Form::label('Tipo_empleado', '*Tipo de empleado: ', ['class' => 'col-form-label']) !!}
                        {!!  Form::select('Typeemployee_id', $tipos, $tipo_empleado->id, ['class' => 'form-control Tipo_Empleado', 'placeholder' => 'Selecciona un tipo de empleado']) !!}
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6" >
                ...
                <div class="form-group row">
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        ...
                        {!!  Form::date('High_date', $contratacion->High_date, ['class' => 'form-control']) !!}
                    </div> 
                     <div class="col-lg-4 col-md-4 col-sm-6">
                        {!!  Form::label('Contrato', '*Tipo de contrato: ', ['class' => 'col-form-label']) !!}
                        {!!  Form::select('Typecontract_id', $contratos, $contratacion->Typecontract_id, ['class' => 'form-control Tipo_contrato', 'placeholder' => 'Selecciona un departamento']) !!}
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 Duracion" style="display: none;">
                        ...
                        {!!  Form::select('Duration', ['30' => '30', '90' => '90', '180' => '180'], null, ['class' => 'form-control Duracion_Dias', 'placeholder' => 'Selecciona un periodo de duración']) !!}    
                    </div>               
                    @else
                    <div class="col-lg-4 col-md-4 col-sm-6 Duracion">
                        {!!  Form::label('Duracion', 'Duración del contrato: ', ['class' => 'col-form-label']) !!}
                        {!!  Form::select('Duration', ['30' => '30', '90' => '90', '180' => '180'], $contratacion->Duration, ['class' => 'form-control Duracion_Dias', 'placeholder' => 'Selecciona un periodo de duración', 'required'=>'true']) !!}
                    </div>
                    @endif  
                </div>
                <div class="form-group row">
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        ...
                        {!!  Form::select('Departament_id', $departamentos, $puesto->Departament_id, ['class' => 'form-control Departament', 'placeholder' => 'Selecciona un departamento']) !!}
                    </div>   
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        
                        {!!  Form::label('Puesto', '*Puesto: ', ['class' => 'col-form-label']) !!}
                        {!!  Form::select('Position_id', $puestos, $puesto->id, ['class' => 'form-control Position', 'placeholder' => 'Selecciona un puesto' , 'value' => old('Position_id') ]) !!}
                    </div>   
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        {!!  Form::label('Reporta', '*Reporta a: ', ['class' => 'col-form-label']) !!}
                        {!!  Form::select('Parent_id', $empleados, $empleado->Parent_id, ['class' => 'form-control Parent', 'placeholder' => 'Selecciona un puesto','value' => old('Parent_id')]) !!}
                    </div>    
                </div>
                <hr>
                ...
                <div class="box-footer" style="text-align: center;">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            @can('Empleado.baja_empleado')
                            <button type="button" class="btn btn-warning btn-sm btn-block" data-toggle="modal" data-target="#modal-warning">
                                Baja de empleado
                            </button>
                            @endcan
                        </div>
...
@include('Empleado.modals.modals_edit')
