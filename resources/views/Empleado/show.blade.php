              ...
              <strong> Fecha de Contratación:</strong> {{ Formato($contratacion->High_date) }}
               ...
               <div class="btn-group-vertical" style="width: 100%;">
				  ...
				  <div class="row">
				   <div class="col-lg-6">
				  <p class="text-muted text-center">
				  @if($empleado->Code<>$min)
				  <a href="{{ route('Empleado.show', $back->Code) }}">
                  <button class="btn btn-primary" ><i class="fa fa-arrow-circle-left" aria-hidden="true"></i></button>
                  </a>
				   @endif
				  </p>
				  </div>
				   <div class="col-lg-6">  
				  <p class="text-muted text-center">					
				  @if($empleado->Code<>$max)
				  <a href="{{ route('Empleado.show', $after->Code) }}">
                  <button class="btn btn-primary"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
                  </a>
				  @endif
				  </p>
				  </div>
               ...
               <div class="row">
                 <div class="col-lg-3"> 
                    <center>
                      ...
                      <div class="col-lg-3"> 
                        <center>
                           <label class="Datos">Dias por antigüedad:</label><br>
                           {{ $dias_disfrutar }}
                        </center> 
                      </div>
                      <div class="col-lg-3"> 
                         <center>
                           <label class="Datos">Saldo actual:</label><br>
                           {{ $saldo }}
                         </center> 
                      </div>
               </div>
