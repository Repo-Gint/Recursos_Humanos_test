    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Parentescos Registrados</h3>
                @can('Familiar.create')
                <a href="{{ route('Familiar.create') }}">
                    <button class="btn btn-success" style="float: right; margin-right: 10px;">
                        <i class="fa fa-plus"></i> Añadir Parentesco
                    </button>
                </a>
                @endcan
            </div>
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-sm" id="tb_familiar" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Parentesco</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    @can('Familiar.edit')
                                    <a href="{{ route('Familiar.edit', $familiar->slug) }}">
                                        <button class="btn btn-primary badge badge-primary" ><i class="fa fa-edit"></i></button>
                                    </a>
                                    @endcan
                                    @can('Familiar.destroy')
                                   <a href="{{ route('Familiar.destroy', $familiar->id) }}">
