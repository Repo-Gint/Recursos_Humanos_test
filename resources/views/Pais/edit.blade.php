...
<div class="row">
    <div class="col-lg-12"> 
        <div class="box box-primary">
            ...
            {!! Form::open(['route' => array('Pais.update', $pais->id), 'method' => 'PUT',  'files' => true]) !!}
                <div class="box-body">
                    <div class="form-group row">
                        <div class="col-lg-3"></div>
                        {!!  Form::label('Pais', 'Pais: ', ['class' => 'col-lg-2 col-xs-3 col-form-label']) !!}
                         <div class="col-lg-4">
                            {!!  Form::text('Country', $pais->Country, ['class' => 'form-control', 'autocomplete' => 'off']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-3"></div>
