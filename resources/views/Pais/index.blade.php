        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-sm" id="tb_pais" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Pais</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $i }}</td>
                                <td>{{ $pais->Country }}</td>
                                <td style="text-align: center;"><img src="{{ asset('images/banderas/'.$pais->Flag) }}" width="40"></td>
                                <td style="text-align: center;">
                                    @can('Pais.edit')
                                    <a href="{{ route('Pais.edit', $pais->Slug) }}">
                                        <button class="btn btn-primary badge badge-primary" ><i class="fa fa-edit"></i></button>
                                    </a>
                                    @endcan
                                    @can('Pais.destroy')
                                    <a href="{{ route('Pais.destroy', $pais->id) }}">
